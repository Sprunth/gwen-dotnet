        ...
        private Key TranslateKeyCode(global::OpenTK.Input.Key key)
        {
            switch (key)
            {
                ...
                case global::OpenTK.Input.Key.Tab:
                    return Key.Tab;
                case global::OpenTK.Input.Key.Space:
                    return Key.Space;
                case global::OpenTK.Input.Key.Up:
                    return Key.Up;
                case global::OpenTK.Input.Key.Down:
                    return Key.Down;
                case global::OpenTK.Input.Key.Left:
                    return Key.Left;
                case global::OpenTK.Input.Key.Right:
                    return Key.Right;
                case global::OpenTK.Input.Key.Home:
                    return Key.Home;
                case global::OpenTK.Input.Key.End:
                    return Key.End;
                case global::OpenTK.Input.Key.Delete:
                    return Key.Delete;
                case global::OpenTK.Input.Key.LControl:
                    this.m_AltGr = true;
                    return Key.Control;
                case global::OpenTK.Input.Key.LAlt:
                    return Key.Alt;
                case global::OpenTK.Input.Key.LShift:
                    return Key.Shift;
                case global::OpenTK.Input.Key.RControl:
                    return Key.Control;
                case global::OpenTK.Input.Key.RAlt:
                    ...
                    return Key.Alt;
                case global::OpenTK.Input.Key.RShift:
                    return Key.Shift;
            }
            return Key.Invalid;
        }
